...
public class FreeFlyCamera : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetMouseButton(1) && !GameManager.Instance.isInteractingUI && !EventSystem.current.IsPointerOverGameObject())
        {
            ...
            GameManager.Instance.isRotatingCamera = true;
        }
        else
        {
            GameManager.Instance.isRotatingCamera = false;
        }
